    ...
    CompositionLocalProvider(LocalControlsVisibilityState provides controlsVisibilityState) {
        Box {
                        ...
                        topView = {
                            AnimatedVisibility(
                                ...
                                ControlsTopView(
                                    ...
                                    onEnhancementClick = {
                                        controlsVisibilityState.hideControls()
                                        overlayView = OverlayView.VIDEO_ENHANCEMENT
                                    },
            ...
            OverlayShowView(
                ...
                videoEnhancementSettings = playerPreferences.videoEnhancement,
                onVideoEnhancementSettingsChanged = viewModel::updateVideoEnhancement,
            )
        }
    }
